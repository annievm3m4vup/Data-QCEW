...
egen B_iv_nmc = sum(loc_ind_iv), by(msa_sc year)
replace B_iv_nmc =. if year==1990 & B_iv_nmc ==0

* Construct the X_it
gen dX_it_nmc = ((loc_all_ind-L.loc_all_ind)/L.loc_all_ind)
rename loc_all_ind loc_all_ind_nmc
collapse (mean)  B_iv_nmc dX_it_nmc loc_all_ind_nmc, by(msa_sc year)
}
save "./export/QCEW/BartikData_version12_nmc.dta", replace
save "/Users/annievm3m4vup/Dropbox/2022Fifthyearpaper/Data/Final/Stata/BartikData_version12_nmc.dta", replace
